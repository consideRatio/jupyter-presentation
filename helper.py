def youtube(video_id):
    ...
    display(HTML('<iframe width="560" height="315" src="https://www.youtube.com/embed/{}?rel=0&amp;controls=1&amp;showinfo=1" frameborder="0" allowfullscreen></iframe>'.format(video_id)))
